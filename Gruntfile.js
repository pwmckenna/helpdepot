// Generated on 2014-09-17 using generator-webapp-rjs 0.4.8
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            js: {
                files: ['<%= yeoman.app %>/scripts/{,*/}*.js', '.tmp/{,*/}*.js'],
                tasks: ['jshint'],
                options: {
                    livereload: true
                }
            ...
            compile: {
                options: {
                    ...
                    processName: function (path) {
                        return require('path').basename(path, '.handlebars');
                    }
                },
                files: {
                    '.tmp/handlebars/templates.js': ['<%= yeoman.app %>/templates/{,*/}*.handlebars']
                }
            }
        },
